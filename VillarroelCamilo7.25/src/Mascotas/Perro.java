...
public class Perro extends Mascota {
	...
	public enum RazaPerro {
		LABRADOR, PASTOR_ALEMAN, GOLDEN_RETRIEVER, BULLDOG, CANICHE, BEAGLE, ROTTWEILER, YORKSHIRE_TERRIER, BOXER,
		DACHSHUND, HUSKY_SIBERIANO, DOBERMAN, GRAN_DANES, CHIHUAHUA, SHIH_TZU, BORDER_COLLIE, COCKER_SPANIEL, DALMATA,
		MALTES, PUG
	}
	...
	public Perro(String nombre, short edad, String estado, LocalDate nacimiento, RazaPerro raza, boolean peloLargo)
